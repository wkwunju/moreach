      ...
      <div className="max-w-4xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Connecting products with the audiences they deserve
          </p>
        </div>

        {/* Story */}
        <div className="prose prose-lg max-w-none">
          <div className="bg-gradient-to-br from-yellow-50 to-green-50 rounded-2xl p-8 md:p-12 mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Story</h2>
            
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              Moreach was born from a simple realization: building a great product is hard, but reaching the right audience is even harder. Our founder, after multiple entrepreneurial ventures, discovered that the biggest challenge wasn't creating something valuable—it was connecting with the people who needed it most.
            </p>

            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              We believe every business and brand has untapped potential. The missing piece isn't the product—it's the connection. That's why we created Moreach: to help founders and brands bridge that gap. Using AI, we detect high-intent signals across online discussions, communities, and influencer networks, making it effortless to find and engage your ideal audience. Because your customers are out there searching—Moreach makes sure they find you.
            </p>

            {/* Mission, Vision, Approach in same block */}
            <div className="space-y-6 pt-6 border-t border-gray-300">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Our Mission</h3>
                <p className="text-gray-700 leading-relaxed">
                  Democratize audience discovery and make meaningful connections accessible to every founder and brand.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  A world where great products effortlessly reach the people who need them most.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  AI-powered intelligence combined with human insight to find high-intent audiences at scale.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* CTA */}
          <div className="text-center bg-gradient-to-br from-yellow-300 via-lime-300 to-green-300 rounded-2xl p-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">
              Ready to connect with your audience?
            </h3>
            <p className="text-lg text-gray-800 mb-8">
              Join founders and brands using Moreach to grow their business
            </p>
            <Link
              href="/register"
              className="inline-block px-8 py-4 bg-gray-900 text-white text-lg font-bold rounded-full hover:bg-gray-800 transition-all shadow-xl"
            >
              Get Started
            </Link>
          </div>
